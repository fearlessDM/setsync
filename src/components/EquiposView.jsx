...
export function EquiposView({onToast,onGestionar,mode,lang='es',equipos=[]}){
  ...
  return(
    <div>
      <div className="ph">
        <div>
          <div style={{fontFamily:"'Special Gothic Expanded One',sans-serif",fontWeight:400,fontSize:32,color:'var(--tx)',lineHeight:1,marginBottom:5}}>{vx.equipoPersona.plural}</div>
