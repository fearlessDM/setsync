...
Como cualquier canción en SetSync, las del Universal se pueden transponer a cualquier tonalidad en tiempo real durante el ensayo o el servicio.
    ...
    metronomoLbl:'Metrónomo',
    tapTempoLbl:'TAP TEMPO',
    cifraLbl:'CIFRA',
    grosorLbl:'GROSOR',
    undoAnnotationLbl:'Deshacer',
    clearAllLbl:'Borrar todo',
    scrollLbl:'Scroll',
    velocidadLbl:'VELOCIDAD',
    enVivoLbl:'En Vivo',
    esperandoEquipoAceptaLbl:'Esperando que el equipo acepte…',
    unsavedChangesDescLbl:'Tienes cambios sin guardar en esta canción. ¿Qué deseas hacer?',
    vistaBloquesLbl:'Vista por Bloques',
    modoProLbl:'Modo Pro',
    blockViewDescLbl:'en pantalla, sin scroll.',
    antLbl:'Ant',
    clickMetronomoTitleLbl:'Click · Metrónomo',
    variacionesOpenFromSongbookLbl:'Se abren desde Cancionero — cierra esta canción y vuelve a entrar eligiendo la variación.',
    sinTrackHintLbl:'Sin track — se sube o graba desde la pestaña Referencia.',
    busLbl:'Bus',
    clickGuiaDeviceOnlyLbl:'🎧 Click y Guía — solo en este dispositivo',
    muteLbl:'MUTE',
    audioFormatsHintLbl:'MP3, AAC, WAV · Toca para seleccionar',
    outLbl:'OUT',
    outSquareLbl:'OUT ■',
    enLaCancionLbl:'En la Canción',
    enUnEnsayoLbl:'En un Ensayo',
    clickRoleLbl:'CLICK',
    guiaRoleLbl:'GUÍA',
    originalSinConvertirLbl:'Original (sin convertir)',
    mp3RecomendadoLbl:'MP3 — recomendado',
    opusMejorCalidadLbl:'Opus — mejor calidad',
    detenerLbl:'DETENER',
    reproducirLbl:'REPRODUCIR',
    dibujandoTocaParaPararLbl:'DIBUJANDO — TOCA PARA PARAR',
    activarLapizLbl:'ACTIVAR LÁPIZ',
    lapizLbl:'Lápiz',
    borradorLbl:'Borrador',
    iniciarAutoscrollLbl:'INICIAR AUTOSCROLL',
    finLbl:'Fin',
    sigLbl:'Sig',
    ipPuentePlaceholderLbl:'IP del puente (ej: 192.168.1.50:8080)',
    ipMesaPlaceholderLbl:'IP de la mesa (ej: 10.10.1.1)',
    clickTrackShortLbl:'Click',
    guiaTrackShortLbl:'Guía',
    ingresaIpMesaErrorLbl:'Ingresa la IP de la mesa',
    anotarTitleLbl:'Anotar',
    autoscrollTitleLbl:'Autoscroll',
    modoEnVivoTitleLbl:'Modo En Vivo',
    vistaPorBloquesTitleLbl:'Vista por bloques',
    vistaLinealTitleLbl:'Vista lineal',
    marcarComoClickLbl:'Marcar como Click',
    marcarComoGuiaLbl:'Marcar como Guía',
    verCarpetaCancionLbl:'Ver carpeta de esta canción',
    editarCancionTitleLbl:'Editar canción',
    anotacionPlaceholderLbl:'Ej: tocar con capo 2, pedir a Juan que suba una tercera en el coro, ojo con el cambio de compás en el puente...',
    elegirEnsayoPlaceholderLbl:'Elegir ensayo…',
    blockViewDescPrefixLbl:'Toda la canción',
    blockViewDescSuffixLbl:'Cada sección ocupa su propio espacio.',
    verCarpetaCancionAttrLbl:'Ver carpeta de esta canción',
    editarCancionAttrLbl:'Editar canción',
    bpm:'BPM',
...
Como qualquer música no SetSync, as do Universal podem ser transpostas para qualquer tom em tempo real durante o ensaio ou o culto.
    ...
    opcionalTagLbl:'· opcional',
    metronomoLbl:'Metrônomo',
    tapTempoLbl:'TAP TEMPO',
    cifraLbl:'COMPASSO',
    grosorLbl:'ESPESSURA',
    undoAnnotationLbl:'Desfazer',
    clearAllLbl:'Apagar tudo',
    scrollLbl:'Scroll',
    velocidadLbl:'VELOCIDADE',
    enVivoLbl:'Ao Vivo',
    esperandoEquipoAceptaLbl:'Aguardando a equipe aceitar…',
    unsavedChangesDescLbl:'Você tem alterações não salvas nesta música. O que deseja fazer?',
    vistaBloquesLbl:'Vista em Blocos',
    modoProLbl:'Modo Pro',
    blockViewDescLbl:'na tela, sem rolagem.',
    antLbl:'Ant',
    clickMetronomoTitleLbl:'Click · Metrônomo',
    variacionesOpenFromSongbookLbl:'Elas abrem pelo Cancioneiro — feche esta música e entre de novo escolhendo a variação.',
    sinTrackHintLbl:'Sem faixa — envie ou grave pela aba Referência.',
    busLbl:'Bus',
    clickGuiaDeviceOnlyLbl:'🎧 Click e Guia — somente neste dispositivo',
    muteLbl:'MUTE',
    audioFormatsHintLbl:'MP3, AAC, WAV · Toque para selecionar',
    outLbl:'OUT',
    outSquareLbl:'OUT ■',
    enLaCancionLbl:'Na Música',
    enUnEnsayoLbl:'Em um Ensaio',
    clickRoleLbl:'CLICK',
    guiaRoleLbl:'GUIA',
    originalSinConvertirLbl:'Original (sem conversão)',
    mp3RecomendadoLbl:'MP3 — recomendado',
    opusMejorCalidadLbl:'Opus — melhor qualidade',
    detenerLbl:'PARAR',
    reproducirLbl:'REPRODUZIR',
    dibujandoTocaParaPararLbl:'DESENHANDO — TOQUE PARA PARAR',
    activarLapizLbl:'ATIVAR LÁPIS',
    lapizLbl:'Lápis',
    borradorLbl:'Borracha',
    iniciarAutoscrollLbl:'INICIAR AUTOSCROLL',
    finLbl:'Fim',
    sigLbl:'Próx',
    ipPuentePlaceholderLbl:'IP da ponte (ex: 192.168.1.50:8080)',
    ipMesaPlaceholderLbl:'IP da mesa (ex: 10.10.1.1)',
    clickTrackShortLbl:'Click',
    guiaTrackShortLbl:'Guia',
    ingresaIpMesaErrorLbl:'Digite o IP da mesa',
    anotarTitleLbl:'Anotar',
    autoscrollTitleLbl:'Autoscroll',
    modoEnVivoTitleLbl:'Modo Ao Vivo',
    vistaPorBloquesTitleLbl:'Vista em blocos',
    vistaLinealTitleLbl:'Vista linear',
    marcarComoClickLbl:'Marcar como Click',
    marcarComoGuiaLbl:'Marcar como Guia',
    verCarpetaCancionLbl:'Ver pasta desta música',
    editarCancionTitleLbl:'Editar música',
    anotacionPlaceholderLbl:'Ex: tocar com capotraste 2, pedir para o João subir uma terça no refrão, atenção na troca de compasso na ponte...',
    elegirEnsayoPlaceholderLbl:'Escolher ensaio…',
    blockViewDescPrefixLbl:'A música inteira',
    blockViewDescSuffixLbl:'Cada seção ocupa seu próprio espaço.',
    verCarpetaCancionAttrLbl:'Ver pasta desta música',
    editarCancionAttrLbl:'Editar música',
    bpm:'BPM',
...
Like any song in SetSync, Universal ones can be transposed to any key in real time during rehearsal or the service.
    ...
    metronomoLbl:'Metronome',
    tapTempoLbl:'TAP TEMPO',
    cifraLbl:'TIME SIG.',
    grosorLbl:'THICKNESS',
    undoAnnotationLbl:'Undo',
    clearAllLbl:'Clear all',
    scrollLbl:'Scroll',
    velocidadLbl:'SPEED',
    enVivoLbl:'Live',
    esperandoEquipoAceptaLbl:'Waiting for the team to accept…',
    unsavedChangesDescLbl:'You have unsaved changes in this song. What would you like to do?',
    vistaBloquesLbl:'Block View',
    modoProLbl:'Pro Mode',
    blockViewDescLbl:'on screen, no scroll.',
    antLbl:'Prev',
    clickMetronomoTitleLbl:'Click · Metronome',
    variacionesOpenFromSongbookLbl:'These open from the Songbook — close this song and re-enter choosing the variation.',
    sinTrackHintLbl:'No track — upload or record it from the Reference tab.',
    busLbl:'Bus',
    clickGuiaDeviceOnlyLbl:'🎧 Click and Guide — this device only',
    muteLbl:'MUTE',
    audioFormatsHintLbl:'MP3, AAC, WAV · Tap to select',
    outLbl:'OUT',
    outSquareLbl:'OUT ■',
    enLaCancionLbl:'In the Song',
    enUnEnsayoLbl:'In a Rehearsal',
    clickRoleLbl:'CLICK',
    guiaRoleLbl:'GUIDE',
    originalSinConvertirLbl:'Original (unconverted)',
    mp3RecomendadoLbl:'MP3 — recommended',
    opusMejorCalidadLbl:'Opus — better quality',
    detenerLbl:'STOP',
    reproducirLbl:'PLAY',
    dibujandoTocaParaPararLbl:'DRAWING — TAP TO STOP',
    activarLapizLbl:'TURN ON PENCIL',
    lapizLbl:'Pencil',
    borradorLbl:'Eraser',
    iniciarAutoscrollLbl:'START AUTOSCROLL',
    finLbl:'End',
    sigLbl:'Next',
    ipPuentePlaceholderLbl:'Bridge IP (e.g. 192.168.1.50:8080)',
    ipMesaPlaceholderLbl:'Mixer IP (e.g. 10.10.1.1)',
    clickTrackShortLbl:'Click',
    guiaTrackShortLbl:'Guide',
    ingresaIpMesaErrorLbl:'Enter the mixer\'s IP',
    anotarTitleLbl:'Annotate',
    autoscrollTitleLbl:'Autoscroll',
    modoEnVivoTitleLbl:'Live Mode',
    vistaPorBloquesTitleLbl:'Block view',
    vistaLinealTitleLbl:'Linear view',
    marcarComoClickLbl:'Mark as Click',
    marcarComoGuiaLbl:'Mark as Guide',
    verCarpetaCancionLbl:'View this song\'s folder',
    editarCancionTitleLbl:'Edit song',
    anotacionPlaceholderLbl:'E.g.: play with capo 2, ask Juan to sing a third up in the chorus, watch the time signature change in the bridge...',
    elegirEnsayoPlaceholderLbl:'Choose rehearsal…',
    blockViewDescPrefixLbl:'The whole song',
    blockViewDescSuffixLbl:'Each section gets its own space.',
    verCarpetaCancionAttrLbl:'View this song\'s folder',
    editarCancionAttrLbl:'Edit song',
    bpm:'BPM',
    // ── Home: Notes widget ───────────────────────────────────────────────────
